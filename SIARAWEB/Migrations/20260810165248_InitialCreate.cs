        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcademicPeriodId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CutoffDates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CutoffDates_AcademicPeriods_AcademicPeriodId",
                        column: x => x.AcademicPeriodId,
                        principalTable: "AcademicPeriods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CutoffDates_AcademicPeriods_AcademicPeriodId1",
                        column: x => x.AcademicPeriodId1,
                        principalTable: "AcademicPeriods",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Subjects_Departamentos_DepartamentoId",
                        column: x => x.DepartamentoId,
                        principalTable: "Departamentos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApprovalPercentage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    FailurePercentage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DropoutPercentage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AcademicTrackings_CutoffDates_CutoffDateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Documents_CutoffDates_CutoffDateId",
                        column: x => x.CutoffDateId,
                        principalTable: "CutoffDates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AcademicTrackings_CutoffDateId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CutoffDates_AcademicPeriodId",
                table: "CutoffDates",
                column: "AcademicPeriodId");

            migrationBuilder.CreateIndex(
                name: "IX_CutoffDates_AcademicPeriodId1",
                table: "CutoffDates",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Documents_CutoffDateId",
                table: "Documents",
                column: "CutoffDateId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subjects_DepartamentoId",
                table: "Subjects",
                column: "DepartamentoId");
        }
