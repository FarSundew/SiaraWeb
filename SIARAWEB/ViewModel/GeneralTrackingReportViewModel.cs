...
namespace SIARAWEB.ViewModel
{
    public class GeneralTrackingReportViewModel
    {
        ...
        public bool OnlyHighRisk { get; set; } // Filtro para ver solo >= 40% de reprobación
        ...
        public int TotalHighRiskUnits { get; set; } // Cuántas unidades tienen reprobación >= 40%
        public decimal GlobalApprovalAverage { get; set; }
        public decimal GlobalFailureAverage { get; set; }

        // Listado plano consolidado para la sábana
    ...
    public class TrackingReportRowItem
    {
        ...
        // Indicador y descripción de la acción correctiva
        public bool IsHighRisk => FailurePercentage >= 40.0m;
        public string? CorrectiveAction { get; set; } // Propiedad Observations del modelo
